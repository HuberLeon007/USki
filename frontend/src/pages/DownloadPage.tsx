...
/** Placeholder until the native build ships. Point this at the real APK later. */
const APK_URL = "/uski-latest.apk";

/**
 * Mobile gateway. The desktop web app is not usable on phones, so phone visitors
 * land here to get the native app instead. Single primary action: download the APK.
 */
    ...
    <div className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden bg-background px-6 text-center">
      ...
      >
        ...
        <a href={APK_URL} download className="w-full">
          <Button className="h-13 w-full gap-2 rounded-2xl text-base font-semibold" style={{ height: "3.25rem" }}>
            <Download className="h-5 w-5" /> Download latest APK
          </Button>
        </a>
